...
if (ctrlMute) { ctrlMute.classList.add('active'); ctrlMute.classList.remove('off'); ctrlMute.innerHTML = '<i class="lucide-volume-2"></i><div class="call-ctrl-label">MUTE</div>'; }

      if (ctrlCam) { ctrlCam.classList.add('active'); ctrlCam.classList.remove('off'); ctrlCam.innerHTML = '<i class="lucide-camera"></i><div class="call-ctrl-label">CAM</div>'; }

      if (ctrlScreen) { ctrlScreen.classList.remove('active'); ctrlScreen.innerHTML = '<i class="lucide-monitor"></i><div class="call-ctrl-label">SHARE</div>'; }
    ...
    function showTapToUnmute() {
      ...
      el.innerHTML = '<i class="lucide-send"></i> TAP TO ENABLE AUDIO';
    ...
    function toggleMute() {
      ...
      btn.innerHTML = (CALL.muted ? '<i class="lucide-volume-x"></i>' : '<i class="lucide-volume-2"></i>') + '<div class="call-ctrl-label">MUTE</div>';
    ...
    function toggleCamera() {
      ...
      btn.innerHTML = (CALL.camOff ? '<i class="lucide-camera-off"></i>' : '<i class="lucide-camera"></i>') + '<div class="call-ctrl-label">CAM</div>';
    ...
    async function toggleScreenShare() {
      if (!CALL.sharing) {
        try {
          ...
          document.getElementById('ctrl-screen').innerHTML = '<i class="lucide-monitor"></i><div class="call-ctrl-label">STOP</div>';
        ...
        document.getElementById('ctrl-screen').innerHTML = '<i class="lucide-monitor"></i><div class="call-ctrl-label">SHARE</div>';
      }
    }
